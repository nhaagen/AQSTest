...
require_once("./Customizing/global/plugins/Services/Repository/RepositoryObject/AQSTest/classes/class.ilAQSTestPlugin.php");
*/

/**
 * @ilCtrl_isCalledBy ilObjAQSTestGUI: ilRepositoryGUI, ilAdministrationGUI, ilObjPluginDispatchGUI
 * @ilCtrl_Calls ilObjAQSTestGUI: ilPermissionGUI, ilInfoScreenGUI, ilObjectCopyGUI, ilCommonActionDispatcherGUI, ilExportGUI
 */
